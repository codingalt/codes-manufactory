...
const Pricing = () => {
  return (
    <div className={css.pricing}>
      ...
      >
        <div
          className="absolute -z-0 bottom-0 left-0 right-0 top-[59%] opacity-[0.3] bg-[linear-gradient(to_right,#1B1B1B_1px,transparent_1px),linear-gradient(to_bottom,#1B1B1B_1px,transparent_1px)] bg-[size:57px_57px]"
        ></div>
      </div>
