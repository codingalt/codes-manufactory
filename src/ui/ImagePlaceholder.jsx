...
const ImagePlaceholder = ({
  ...
  return (
    <div
      className={`${
        !imageLoaded &&
        "shadow-black/40 min-h-52 shadow-none bg-content3-foreground before:opacity-100 before:absolute before:inset-0 before:-translate-x-full before:animate-[shimmer_3s_infinite] before:border-t before:border-content4/30 before:bg-gradient-to-r before:from-transparent before:via-content4 before:to-transparent after:opacity-100 after:absolute after:inset-0 after:-z-10 after:bg-content3"
